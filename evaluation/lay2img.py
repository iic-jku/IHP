...
def main(
    ...
    for background in backgrounds:
        lv.set_config("background-color", background_colors[background])
        lv.save_image_with_options(
            os.path.join(directory, base_name + "_" + background + ".png"),
            width,
            height,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="both",
        help="which background(s) to render (default: both)",
    )

    args = parser.parse_args()

    backgrounds = ["white", "black"] if args.background == "both" else [args.background]
