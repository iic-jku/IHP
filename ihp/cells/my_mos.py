...
def my_pmos(
    ...
    # ----------------------------------------------------------------
    c = gf.import_gds(gdspath="pmos_test.gds", post_process=_add_ports)
